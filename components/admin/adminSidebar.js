...
const AdminSidebar = () => {
  ...
  return (
    <>
      {/* <div className=" bg-black h-screen pt-[20%] text-white">
        <ul className="block">
      ...
      {/* code */}
      <div className=" w-[10%] lg:w-[20%] min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased text-gray-800">
