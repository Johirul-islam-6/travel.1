...
useEffect(()=>{
    ...
    return ( 
        ...
        <div class="flex items-center justify-center min-h-screen p-10 bg-gradient-to-tl from-green-400 to-indigo-900 min-w-screen">
            <div class="max-w-xl p-12 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl mt-28">
                <h3 class="text-2xl">Thanks for signing up for Travel.Xone!</h3>
